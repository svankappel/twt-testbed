...
int main(void)
{
    ...
    static int i = 0;
    struct test_sensor_twt_settings test_settings1 = {
                    .iterations = 1000,
                    .twt_interval = 5000,
    ...
    test_sensor_twt(&test_settings1);

    struct test_sensor_twt_settings test_settings2 = {
                    .iterations = 1000,
                    .twt_interval = 10000,
                    .twt_wake_interval = 32,
                    .test_id = i++, 
    ...
    test_sensor_twt(&test_settings2);
